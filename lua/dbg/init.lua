...
vim.api.nvim_set_keymap('n', '<leader>dct', '<cmd>lua require"dap".continue()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>dsv', '<cmd>lua require"dap".step_over()<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<leader>dtb', '<cmd>lua require"dap".toggle_breakpoint()<CR>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', '<leader>dsc', '<cmd>lua require"dap.ui.variables".scopes()<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<leader>dcc',
          '<cmd>lua require"telescope".extensions.dap.commands{}<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>dco',
          '<cmd>lua require"telescope".extensions.dap.configurations{}<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>dlb',
          '<cmd>lua require"telescope".extensions.dap.list_breakpoints{}<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>dv',
          '<cmd>lua require"telescope".extensions.dap.variables{}<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>df',
          '<cmd>lua require"telescope".extensions.dap.frames{}<CR>', { noremap = true, silent = true })